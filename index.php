...
<body>
	...
	<header id="home">
		<!-- Background Image -->
		<div class="bg-img" style="background-image: url('img/Футбольное поле.jpg');">
				...
				<div class="row">
					...
					<div class="col-md-10 col-md-offset-1">
						<div class="home-content">
							...
							<a href="index.php#about" class="main-btn">Подробнее</a>
						</div>
					</div>
					<!-- /home content -->
				</div>
	...
	<div id="about" class="section md-padding">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="about">
						<img class="icon" src="img/футбольный&#32;мяч.svg" alt="">
				...
				<div class="col-md-4">
					<div class="about">
						<img class="icon" src="img/Тренажерный&#32;зал.svg" alt="">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-6 col-xs-6 work">
					<img class="img-responsive visible_photo scale-with-grid" src="img/Крытое&#32;поле&#32;ОЛИМП.jpg" alt="rose">
					<img class="img-responsive hidden_photo scale-with-grid" src="img/Мини&#32;футбольное&#32;поле.jpg" alt="rose2">
				</div>
				<!-- /Work -->

				<!-- Work -->
				<div class="col-md-6 col-xs-6 work">
						<img class="img-responsive visible_photo scale-with-grid" src="img/Крытое&#32;футбольное&#32;поле&#32;с&#32;отличным&#32;освещением.jpg" alt="potolok">
						<img class="img-responsive hidden_photo scale-with-grid" src="img/Крытое&#32;мини&#32;футбольное&#32;поле.jpg" alt="potolok2">
					</div>
				<!-- /Work -->

				<!-- Work -->
				<div class="col-md-6 col-xs-6 work">
						<img class="img-responsive visible_photo scale-with-grid" src="img/Мини&#32;футбольное&#32;поле.jpg" alt="janart">
						<img class="img-responsive hidden_photo scale-with-grid" src="img/Крытое&#32;футбольное&#32;поле&#32;с&#32;отличным&#32;освещением.jpg" alt="janart2">
					</div>
				<!-- /Work -->

				<!-- Work -->
				<div class="col-md-6 col-xs-6 work">
						<img class="img-responsive visible_photo scale-with-grid" src="img/Крытое&#32;мини&#32;футбольное&#32;поле.jpg" alt="warnir">
						<img class="img-responsive hidden_photo scale-with-grid" src="img/Мини&#32;футбольное&#32;поле.jpg" alt="warnir2">
					</div>
				<!-- /Work -->
			...
			<div class="row">
				...
				<div class="col-md-5 col-md-offset-1">
					<div id="about-slider" class="owl-carousel owl-theme">
						<img class="img-responsive" src="img/Крытое&#32;поле&#32;ОЛИМП.jpg" alt="">
						<img class="img-responsive" src="img/Мини&#32;футбольное&#32;поле.jpg" alt="">
	...
	<div id="numbers" class="section sm-padding">
		...
		<!-- Background Image -->
		<div class="bg-img" style="background-image: url('img/Футбольное поле Олимп.jpg');">
			<div class="overlay"></div>
		</div>
		<!-- /Background Image -->
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="blog">
						<div class="blog-img">
							<img class="img-responsive" src="img/brick.jpg" alt="">
						</div>
						<div class="blog-content">
							<ul class="blog-meta">
							<li><i class="fa fa-user"></i>Адылбек Ражапов</li>
							<li><i class="fa fa-clock-o"></i>05.06.2020, 09:10</li>
							<!-- <li><i class="fa fa-comments"></i>57</li> -->
							</ul>
							<h3>Кирпичный завод <a target="_blank" href="http://www.olimp1.kg/www.kantimal.kg">WWW.KANTIMAL.KG</a></h3>
							<p>Кирпичный завод ОсОО «КанТиМал» реализует кирпич полублок трёхдырчатый М100. Размер: 250х120х90мм.
                            Имеется сертификат качества. Цена зависит от обьема закупок. 
                            Имеется доставка. <a target="_blank" href="http://www.olimp1.kg/www.kantimal.kg">Подробно...</a></p>
				...
				<div class="col-md-3">
					<div class="blog">
						<div class="blog-img">
							<img class="img-responsive"  src="img/Мини&#32;футбольное&#32;поле&#32;Олимп.jpg" alt="">
						</div>
						<div class="blog-content">
							<ul class="blog-meta">
								<li><i class="fa fa-user"></i>Адылбек Ражапов</li>
				...
				<div class="col-md-3">
					<div class="blog">
						<div class="blog-img">
							<img class="img-responsive" src="img/Спортивный&#32;комплекс&#32;ОЛИМП.jpg" alt="">
						</div>
						<div class="blog-content">
							<ul class="blog-meta">
								<li><i class="fa fa-user"></i>Адылбек Ражапов</li>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<p class="text-center">Оставьте отзыв или задайте вопрос. 
					Мы обязательно примем во внимание ваши пожелания и учтем это в будущем. 
					Искренне надеемся, что Ваши отзывы дадут возможность усовершенствовать нашу работу.
					Для нас важен каждый отклик! Спасибо, что Вы с нами.</p>
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="footer-copyright">
						<p>© 2018-2020. Designed by <a href="https://www.linkedin.com/in/kanykei-razhapova-b18ba8a1/" target="_blank">Kanykei Razhapova</a></p>
					</div>
					<!-- /footer copyright -->
